  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 300 },    // Section 0 - QuickClaw
        { x: 0, y: 40, z: -50 },     // Section 1 - DEPLOY
        { x: 0, y: 50, z: -700 }       // Section 2 - DASHBOARD
      ];
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        ...
        <div className="vertical-text">QUICKCLAW</div>
      </div>

      {/* Main content */}
      <div className="hero-content cosmos-content">
        <h1 ref={titleRef} className="hero-title">
          {splitTitle("QUICKCLAW")}
        </h1>

        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            One-click OpenClaw hosting, without a CLI.
          </p>
          <p className="subtitle-line">
            Paste your Telegram or Discord token and go live.
          </p>
        </div>
      </div>
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string }> = {
            0: {
              line1: 'One-click OpenClaw hosting, without a CLI.',
              line2: 'Paste your Telegram or Discord token and go live.'
            },
            1: {
              line1: 'Deploy your bot in seconds,',
              line2: 'no configuration required'
            },
            2: {
              line1: 'Monitor your bots, manage tokens,',
          ...
          return (
            <section key={i} className="content-section">
              <h1 ref={titleRef} className="hero-title">
                {splitTitle(titles[i + 1] || 'QUICKCLAW')}
              </h1>

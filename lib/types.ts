export type ModelId =
  ...
  | "minimax/MiniMax-M2.1-80k"
  | "minimax/MiniMax-M2.1-thinking"
  | "minimax/MiniMax-M2.1-thinking-80k"
  | "moonshot/kimi-k2.5"
  | "nvidia/moonshotai/kimi-k2.5";

export type ChannelId = "telegram" | "discord" | "slack";
export type PlanId = "starter" | "pro";
export type ModelProviderId = "openrouter" | "openai" | "minimax" | "moonshot" | "nvidia";
...
export type BrandResearchPhase = "fast" | "deep";
export type BrandResearchRunStatus = "pending" | "running" | "complete" | "failed";
export type BrandResearchSourceType = "website" | "social" | "coverage" | "competitor" | "other";
export type BrandResearchFactType =
  | "positioning"
  | "audience"
  | "product"
  | "tone"
  ...
  | "competitor"
  | "topic";
export type BrandResearchFactConfidenceLabel = "verified" | "inferred" | "low_confidence";

export type BillingType = "deploy" | "credits";
export type XActionType = "post" | "reply";
export type XActionStatus = "sent" | "blocked" | "failed";
...
export interface BrandResearchRunRecord {
  id: string;
  deploymentId: string;
  phase: BrandResearchPhase;
...
export interface BrandResearchSourceRecord {
  id: string;
  runId: string;
  url: string;
  domain: string | null;
  sourceType: BrandResearchSourceType;
...
export interface BrandResearchFactRecord {
  id: string;
  runId: string;
  key: string;
  value: string;
  confidence: number;
  confidenceLabel: BrandResearchFactConfidenceLabel;
  evidenceSourceIds: string[];
  factType: BrandResearchFactType;
  createdAt: string;
}
...
export interface XActionLogRecord {
  id: string;
  deploymentId: string;
